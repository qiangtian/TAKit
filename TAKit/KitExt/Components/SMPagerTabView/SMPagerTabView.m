    ...
    for (int i = 0; i < number; i++) {
        ...
        //TODO  添加的  ktv中选择日期的时候显示的
        {
            ...
            if (_isTwoLine) {
                ...
                //self.selectedLineWidth = self.frame.size.width/number;
                
                //[itemButton setFrame:CGRectMake( self.width/number*i, 0, self.width/number, self.tabFrameHeight)];
            }
...
- (void)layoutSubviews {
    if (_isBuildUI) {
        //TODO  添加下横线
        UILabel *line = [[UILabel alloc]initWithFrame:CGRectMake(0, self.tabFrameHeight-0.5, self.bounds.size.width, 0.5)];
       // line.backgroundColor = [UIColor colorWithRed:226 green:226 blue:226 alpha:1];
