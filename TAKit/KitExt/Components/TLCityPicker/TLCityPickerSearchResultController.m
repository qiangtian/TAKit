...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    [self.tableView setFrame:CGRectMake(0, 64+45, self.view.frame.size.width, [UIScreen mainScreen].bounds.size.height - 64-45)];
}
...
//    [cell.textLabel setText:city.cityName];
    [cell.textLabel setText:city.shortName];
